...
protected:
	...
	virtual char** choose_words_old(char **patterns_table);  // with function get_text finding a words with property number of syllabes
	...
	virtual string choose_words(char**patterns_table);
